const rclockProjectsConstants = {
    ...
    aboutProject : '<p>O Rclock é um software que cria um relógio digital em interfaces de linha de comando.</p>\
                    <p>Esse projeto foi planejado para ter um conjunto de features customizaveis,\
                    permitindo que se encaixe perfeitamente em qualquer workspace. O objetivo do Rclock é ser\
                    compatível com qualquer sistema que siga as normas POSIX.</p>'
}

const assemblyToolkitConstants = {
